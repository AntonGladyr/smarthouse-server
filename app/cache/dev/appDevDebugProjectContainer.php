...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'database.mysql' => 'getDatabase_MysqlService',
            ...
            'web_socket' => 'getWebSocketService',
        );
        $this->aliases = array(
    ...
    /**
     * Gets the 'database.mysql' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \DatabaseBundle\MySQL A DatabaseBundle\MySQL instance.
     */
    protected function getDatabase_MysqlService()
    {
        return $this->services['database.mysql'] = new \DatabaseBundle\MySQL($this->get('doctrine.dbal.default_connection'));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'dbname' => 'HomeControl', 'user' => 'root', 'password' => 191978, 'charset' => 'UTF8', 'port' => NULL, 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_5542404a522b3fdb349fabb6d91816de656fc41d86e8639440b004dda4b85ca1');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/WebSocketBundle/Resources/views'), 'WebSocket');
        $instance->addPath(($this->targetDirs[3].'/src/RESTBundle/Resources/views'), 'REST');
        $instance->addPath(($this->targetDirs[3].'/src/WebViewsBundle/Resources/views'), 'WebViews');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('8d9db9d3b6d2089fad3bfffbf775578849fd72dd');
    }
    ...
    /**
     * Gets the 'web_socket' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \WebSocketBundle\WebSocket A WebSocketBundle\WebSocket instance.
     */
    protected function getWebSocketService()
    {
        return $this->services['web_socket'] = new \WebSocketBundle\WebSocket();
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('571a1552d92c34.11130562')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'WebSocketBundle' => 'WebSocketBundle\\WebSocketBundle',
                'RESTBundle' => 'RESTBundle\\RESTBundle',
                'WebViewsBundle' => 'WebViewsBundle\\WebViewsBundle',
            ...
            'secret' => '8d9db9d3b6d2089fad3bfffbf775578849fd72dd',
            'locale' => 'en',
            ...
            'kernel.secret' => '8d9db9d3b6d2089fad3bfffbf775578849fd72dd',
